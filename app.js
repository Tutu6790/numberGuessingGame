...
let numGuesses = 1;
let playGame = true;
let name = prompt('Hello dear, Please input your name');
alert(name + '!' + ' ' + 'Welcome to Debbie\'s Number Guessing Game!' + ' '+ 'Let\'s see if you\'re up for the challenge')
...
function checkGuess(guess){
    ...
    if (guess === randomNumber){
        displayMessage(`Conragtulations ${name}! You guessed correctly!`);
        endGame();
